#include "ui/welcome_window.hpp"

namespace minesweeper::ui {

WelcomeWindow::WelcomeWindow(int rows, int cols){
...
std::string WelcomeWindow::get_character_name(){
...
void WelcomeWindow::init_window(){
    // init window!
...
void WelcomeWindow::init_variables(int rows, int cols){
    // init all variables
...
void WelcomeWindow::setup_text(sf::Text &text, std::string message, sf::Font &font, bool bold, bool underlined, sf::Color color, int size, sf::Vector2f position){
...
void WelcomeWindow::setTextPos(sf::Text &text, float x, float y){
...
void WelcomeWindow::update_username(){
    // update username?
