...
DigitDisplay::DigitDisplay(int digits, int x, int y, sf::Texture * digits_texture, bool n){
...
void DigitDisplay::set_digit(sf::Sprite &digit, int num){
...
void DigitDisplay::set_display(int val){
...
void DigitDisplay::draw(sf::RenderWindow &window){
